...
create table workunit (
    ...
    need_validate           tinyint         not null,
    ...
    error_mask              tinyint         not null,
    file_delete_state       tinyint         not null,
    assimilate_state        tinyint         not null,
    hr_class                integer         not null,
    opaque                  double          not null,
    min_quorum              smallint        not null,
    target_nresults         smallint        not null,
    max_error_results       smallint        not null,
    max_total_results       smallint        not null,
    max_success_results     smallint        not null,
...
create table result (
    ...
    server_state            tinyint         not null,
    outcome                 tinyint         not null,
    client_state            tinyint         not null,
    ...
    batch                   integer         not null,
    file_delete_state       tinyint         not null,
    validate_state          tinyint         not null,
    ...
    gui_state               tinyint         not null default 0,
    primary key (id)
) engine=InnoDB;
